...
// ── SVG Icon Library ──────────────────────────────────────────────────────────
// Clean, consistent line icons. All icons are 24x24 viewBox, stroke-based.
// Use iconSvg(name, color, size) to render.

const ICONS = {
  // Legal / Professional Services
  'scale': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 6l3 1m0 0l-3 9a5 5 0 006.5 0L6 7m0 0l3-1m-3 1l-3-1m12 1l3 1m0 0l-3 9a5 5 0 006.5 0L18 7m0 0l3-1m-3 1l-3-1M9 7h6"/>`,
  'gavel': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/>`,
  ...
  'building': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z"/>`,
  ...
  'handshake': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"/>`,
  ...
  'money': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z"/>`,
  ...
  'target': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zm-7.518-.267A8.25 8.25 0 1120.25 10.5M8.288 14.212A5.25 5.25 0 1117.25 10.5"/>`,
  'chart-up': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941"/>`,
  ...
  'activity': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.75 12h2.5l2-5.5 3 11 3-9.5 2 4h3.5"/>`,
  ...
  'leaf': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 01-1.161.886l-.143.048a1.107 1.107 0 00-.57 1.664c.369.555.169 1.307-.427 1.605L9 13.125l.423 1.059a.956.956 0 01-1.652.928l-.679-.906a1.125 1.125 0 00-1.906.172L4.5 15.75l-.612.153M12.75 3.031a9 9 0 00-8.862 12.872M12.75 3.031a9 9 0 016.69 14.036m0 0l-.177-.529A2.249 2.249 0 0017.5 15.28l-.146.054a2.25 2.25 0 01-2.688-.943l-.072-.12a2.25 2.25 0 00-2.914-.759l-.171.07a4.5 4.5 0 01-1.53.316h-.007a4.5 4.5 0 01-1.116-8.903l.042-.009"/>`,

  // Hospitality / Food
  'utensils': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.513m6-4.87c1.355 0 2.697.056 4.024.166C17.155 8.51 18 9.473 18 10.608v2.513m-3-4.87v-1.5m-6 4.5v.5m6-.5v.5"/>`,
  ...
  'ruler': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3"/>`,
  ...
  'arrow-right': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/>`,
  ...
  'plane': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"/>`,
  'award': `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M7.73 9.728a6.726 6.726 0 002.748 1.35m8.272-6.842V4.5c0 2.108-.966 3.99-2.48 5.228m2.48-5.492a46.32 46.32 0 012.916.52 6.003 6.003 0 01-5.395 4.972m0 0a6.726 6.726 0 01-2.749 1.35m0 0a6.772 6.772 0 01-3.044 0"/>`,
}

// ── Emoji → icon name mapping ──────────────────────────────────────────────────
const EMOJI_MAP = {
  // Legal
  '⚖️': 'scale', '🏛️': 'building', '📄': 'document', '📜': 'document',
  '🤝': 'handshake', '🛡️': 'shield', '⚒️': 'gavel', '🔨': 'hammer',
  // Finance
  '🏦': 'bank', '💰': 'money', '💵': 'money', '💹': 'chart-up',
  '📊': 'chart', '💎': 'star',
  // Business
  '💼': 'briefcase', '🌍': 'globe', '🌐': 'globe', '👥': 'users',
  '⭐': 'star', '🌟': 'star', '🏆': 'award', '🎯': 'target',
  // Tech
  '⚡': 'bolt', '🖥️': 'cpu', '🔒': 'lock', '🚀': 'rocket',
  // Health
  '❤️': 'heart', '💪': 'activity', '☀️': 'sun', '🌿': 'leaf',
  // Food / Hospitality
  '🍽️': 'utensils', '🗺️': 'map', '🏠': 'home', '🏡': 'home',
  // Construction
  '🚚': 'truck', '📐': 'ruler',
  // Communication
  '✅': 'check', '→': 'arrow-right', '✨': 'sparkles',
  '⏰': 'clock', '📱': 'phone', '✉️': 'envelope',
  '✈️': 'plane', '🛫': 'plane',
  // Generic
  '🎖️': 'award', '🏅': 'award',
}

// ── Keyword → icon name mapping (for text-based icon selection) ───────────────
const KEYWORD_MAP = [
  // Legal
  [['law', 'legal', 'litigation', 'court', 'justice', 'arbitration', 'dispute'], 'scale'],
  [['corporate', 'company', 'business', 'commercial', 'contract'], 'briefcase'],
  [['banking', 'bank', 'finance', 'financial', 'capital', 'fund', 'investment'], 'bank'],
  [['merger', 'acquisition', 'm&a', 'transaction', 'deal'], 'handshake'],
  [['real estate', 'property', 'construction', 'building'], 'building'],
  [['aviation', 'maritime', 'shipping', 'aircraft', 'airline'], 'plane'],
  [['employment', 'labour', 'labor', 'hr', 'human resources'], 'users'],
  [['document', 'contract', 'agreement', 'filing'], 'document'],
  [['compliance', 'regulation', 'regulatory'], 'shield'],
  [['tax', 'accounting', 'audit'], 'chart'],
  // Tech
  [['fast', 'speed', 'quick', 'instant', 'rapid'], 'bolt'],
  [['security', 'secure', 'protect', 'safe', 'privacy'], 'lock'],
  [['launch', 'grow', 'scale', 'expand'], 'rocket'],
  [['analytics', 'data', 'insight', 'report', 'metric'], 'chart-up'],
  [['target', 'goal', 'focus', 'precision'], 'target'],
  [['global', 'international', 'worldwide', 'cross-border'], 'globe'],
  [['team', 'expert', 'specialist', 'partner'], 'users'],
  [['award', 'recognition', 'trust', 'reputation', 'excellence'], 'award'],
  [['time', 'schedule', 'deadline', 'always'], 'clock'],
  // Health
  [['health', 'wellness', 'fitness', 'wellbeing'], 'heart'],
  [['active', 'training', 'workout', 'exercise'], 'activity'],
  // Default
  [['star', 'best', 'top', 'premium', 'quality'], 'star'],
  [['home', 'house', 'property'], 'home'],
  [['contact', 'call', 'phone'], 'phone'],
  [['email', 'message', 'communicate'], 'envelope'],
]
...
function resolveIconName(icon) {
  ...
  for (const [keywords, name] of KEYWORD_MAP) {
...
function iconSvg(icon, color = 'currentColor', size = 28) {
  const name = resolveIconName(icon)
  const path = ICONS[name] || ICONS['sparkles']
  return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" xmlns="http://www.w3.org/2000/svg">${path}</svg>`
}

module.exports = { iconSvg, ICONS, EMOJI_MAP, resolveIconName }
